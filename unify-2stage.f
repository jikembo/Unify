...
C====================================================
      ...
      DO 100 IA=1,MOA
      DO 100 IC=1,3
C     if(myid.eq.master) WRITE(11,1) R(IP,IA,IC),
      READ(11,1) R(IP,IA,IC),
     *VEL(IP,IA,IC),ACC(IP,IA,IC)
100   CONTINUE 
      if(myid.eq.master) WRITE(6,2)
C====================================================
...
C==================================================
C==================================================
      WRITE(6,1) IG,AINERTIA
      WRITE(6,2) (PPP(N),N=1,3)
      WRITE(6,3) (HHH(N),N=1,3)
      WRITE(6,4) (VBAR(N),N=1,3)
      WRITE(6,5) (RC(N),N=1,3)
C==================================================
C==================================================
